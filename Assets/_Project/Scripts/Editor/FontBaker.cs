...
namespace DogtorBurguer
{
    ...
    public static class FontBaker
    {
        ...
        private static readonly (int from, int to)[] Ranges =
        {
            ...
            // Store currency symbols Baloo carries (rupee 20B9, won 20A9, dong 20AB, peso 20B1,
            // lira 20BA, ruble 20BD) — MoneyLabel shows a symbol only when it's in the atlas.
            (0x20A9, 0x20A9), (0x20AB, 0x20AB), (0x20B1, 0x20B1), (0x20B9, 0x20BA),
            (0x20BD, 0x20BD),
        };
