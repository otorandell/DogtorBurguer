# Generates Resources/UI imports for the Game Over screen art (drop №3).
...
# ui_btn_yellow (Retry blank) and ui_btn_cream (Gems blank) were imported with the menu batch.

$repo = "C:\Users\oscar\Documents\Repos\DogtorBurguer"
$src  = "$repo\Assets\RawArt\Dogtor Burger-20260720T104655Z-1-001\Dogtor Burger\Assets\Game over screen"
$dst  = "$repo\Assets\_Project\Resources\UI"

# name, source, width, height, maxTextureSize
$items = @(
    @("ui_gameover_panel", "Game_Over_Background.png", 2327, 4138, 4096),
    @("ui_btn_green",      "Main_Menu_Button.png",      942,  633, 2048),
    @("ui_btn_blue_watch", "Watch_Button_W_Icon.png",   865,  435, 2048)
)
